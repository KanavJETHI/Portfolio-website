            ...
            <div className='flex flex-col justify-center space-y-8'>
                <div>
                    ...
                    <p className='text-gray-600 mt-2'>
                        <a href="#" className='text-blue-500 hover:underline'>jethikanav@gmail.com</a>
                    </p>
                </div>
                <div>
                    <h3 className='text-2xl font-semibold text-gray-300'>Phone</h3>
                    <p className='text-gray-600 mt-2'>
                        <a href="#" className='text-blue-500 hover:underline'>+91 7986725079</a>
                    </p>
                </div>
                <div>
                    ...
                    <div className='flex gap-3 text-2xl transition-all mt-5'>
                        ...
                        <a href='https://www.instagram.com/kanav.jethi?igsh=MTZ3dzluNHkybmps' target='_blank '>
                            <FaInstagram className='text-blue-400' />
                        </a>
                        
                        <a href='https://www.linkedin.com/in/kanav-jethi/' target='_blank'>
                            <FaLinkedin className='text-blue-400' />
                        </a>
                        <a href='https://x.com/iamKjethi?t=195_YdrRIucQOiY-yNdFnQ&s=09' target='_blank'>
